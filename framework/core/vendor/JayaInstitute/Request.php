...
class Request {
	...
	public function uri()
	{
		...
		return static::$uri = isset($_SERVER['REQUEST_URI']) ? str_replace(basename(\Url::baseUrl()).'/', '', (substr($_SERVER['REQUEST_URI'], 1))) : substr((isset($_SERVER['PATH_INFO'])) ? $_SERVER['PATH_INFO'] : @getenv('PATH_INFO'), 1);
	}
